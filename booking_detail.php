...
<?php 
$kode=$_GET['kode'];
$sql1 	= "SELECT booking.*,barang.*, merek.* FROM booking,barang,merek WHERE booking.id_barang=barang.id_barang AND merek.id_merek=barang.id_merek and booking.kode_booking='$kode'";
$query1 = mysqli_query($koneksidb,$sql1);
$result = mysqli_fetch_array($query1);
$harga	= $result['harga'];
$durasi = $result['durasi'];
$jumlah_boking = $result['jumlah_boking'];
$totalbarang = $durasi*$harga*$jumlah_boking;
$drivercharges = $result['driver'];
$totalsewa = $totalbarang+$drivercharges;
	...
	<div class="user_profile_info">	
        ...
        <form method="post" name="sewa" onSubmit="return valid();"> 
			...
			<label>Kode Sewa</label>
				<input type="text" class="form-control" name="barang" value="<?php echo $result['kode_booking'];?>"readonly>
            </div>
			<input type="hidden" class="form-control" name="vid"  value="<?php echo $vid;?>"required>
            <div class="form-group">
			<label>Alat</label>
				<input type="text" class="form-control" name="barang" value="<?php echo $result['nama_merek']; echo ", "; echo $result['nama_barang'];?>"readonly>
            </div>

             <div class="form-group">
			<label>Harga Sewa Satuan</label>
				<input type="text" class="form-control" name="barang" value="<?php echo format_rupiah($result['harga']);?>"readonly>
            </div>
            ...
            <label>Jumlah Barang</label>
				<input type="text" class="form-control" name="durasi" value="<?php echo $jumlah_boking;?>"readonly>
            </div>
            <div class="form-group">
			<label>Biaya Alat (<?php echo $durasi;?> Hari)</label><br/>
				<input type="text" class="form-control" name="biayabarang" value="<?php echo format_rupiah($totalbarang);?>"readonly>
            </div>
            <!--<div class="form-group">
