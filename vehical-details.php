...
$sql = "SELECT barang.*, merek.* from barang, merek WHERE merek.id_merek=barang.id_merek AND barang.id_barang='$vhid'";
...
<section class="listing-detail">
  <div class="container">
    <div class="listing_detail_head row">
      <div class="col-md-9">
        <h2><?php echo htmlentities($result['nama_merek']);?>, <?php echo htmlentities($result['nama_barang']);?></h2>
      </div>
      <div class="col-md-3">
      ...
      <div class="col-md-9">
        <div class="main_features">
          <ul>
            ...
            <li> <i class="fa fa-toggle-on" aria-hidden="true"></i>
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Deskripisi Alat</a></li>
