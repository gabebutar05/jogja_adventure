...
if($_GET) {
	...
	$sqlsewa = "SELECT booking.*,barang.*,merek.*,users.* FROM booking,barang,merek,users WHERE booking.id_barang=barang.id_barang
				AND merek.id_merek=barang.id_merek AND users.email=booking.email AND booking.kode_booking='$Kode'";
...
<table width="100%">
	...
	<tr>
		...
		<td width="2%"><b>:</b></td>
		<td width="78%"><?php echo $result['nama_merek'];?>, <?php echo $result['nama_barang'];?></td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
	...
	<tr>
		...
		<td width="2%"><b>:</b></td>
		<td width="78%"><?php echo $result['jumlah_boking'];?></td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
	...
	<tr>
		...
		<td width="2%"><b>:</b></td>
		<td width="78%"><?php echo $biayabarang;?></td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
