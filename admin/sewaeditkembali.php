...
header('location:index.php');
	...
	if(isset($_POST['submit'])){
		...
		if($status=='Selesai'){
			$mySql2	= "UPDATE barang SET seating = seating+$jumlah_boking WHERE id_barang='$idbarang'";
...
<head>
	...
	<title>Jogja Adventure | Admin Edit Sewa Barang</title>
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<?php 
										$id=$_GET['id'];
										$sqlsewa = "SELECT booking.*,barang.*,merek.*,users.* FROM booking,barang,merek,users WHERE booking.id_barang=barang.id_barang
													AND merek.id_merek=barang.id_merek AND users.email=booking.email AND booking.kode_booking ='$id'";
										$querysewa = mysqli_query($koneksidb,$sqlsewa);
										$result = mysqli_fetch_array($querysewa);
										$biayabarang=$result['durasi']*$result['harga']*$result['jumlah_boking'];
										$total = $result['driver']+$biayabarang;
										?>
										...
										<form method="post" class="form-horizontal" name="theform" enctype="multipart/form-data">
											...
											<input type="hidden" name="jumlah_boking" value="<?php echo $result['jumlah_boking'];?>">
									...
									<div class="panel-heading">Detail Sewa</div>
										...
										<form>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="namabarang" class="form-control" value="<?php echo $result['nama_barang'];?>" required readonly>
												</div>
											</div>
											<br/>
											<!--<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="biayabarang" class="form-control" value="<?php echo format_rupiah($biayabarang);?>" required readonly>
												</div>
											</div>
											<br/>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="jumlah" class="form-control" value="<?php echo $result['jumlah'];?>" required readonly>
												</div>
											</div>
											</form>
									</div>
