...
<head>
	...
	<title>Rental Barang | Admin Kelola Sewa   </title>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
										...
										$sqlsewa = "SELECT booking.*,barang.*,merek.*,users.* FROM booking,barang,merek,users WHERE booking.id_barang=barang.id_barang
													AND merek.id_merek=barang.id_merek AND users.email=booking.email ORDER BY booking.kode_booking DESC";
										...
										<tr align="center">
											...
											<td><?php echo htmlentities($result['jumlah_boking']);?></td>
