...
<head>
	...
	<title>Jogja Adventure | Admin Edit Info Alat</title>
...
function valid(theform){
		...
		alert ('Hanya huruf yang diperbolehkan untuk Nama Barang!');
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<?php 
										$id=intval($_GET['id']);
										$sql ="SELECT barang.*,merek.* FROM barang, merek WHERE barang.id_merek=merek.id_merek AND barang.id_barang='$id'";
										$query = mysqli_query($koneksidb,$sql);
										$result = mysqli_fetch_array($query);
										?>

										<form method="post" class="form-horizontal" name="theform" action ="barangeditact.php" onsubmit="return valid(this);" enctype="multipart/form-data">
										<div class="form-group">
											<label class="col-sm-2 control-label">Nama Alat<span style="color:red">*</span></label>
											<div class="col-sm-4">
												<input type="hidden" name="id" class="form-control" value="<?php echo $id;?>" required>
												<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result['nama_barang']);?>" required>
											</div>
										...
										<div class="form-group">
											<div class="col-sm-4">
												...
												<a href="changeimage1.php?imgid=<?php echo htmlentities($result['id_barang'])?>">Ganti Gambar 1</a>
											</div>
											<div class="col-sm-4">
												Gambar 2<img src="img/vehicleimages/<?php echo htmlentities($result['image2']);?>" width="300" height="200" style="border:solid 1px #000">
												<a href="changeimage2.php?imgid=<?php echo htmlentities($result['id_barang'])?>">Ganti Gambar 2</a>
											</div>
											<div class="col-sm-4">
												Gambar 3<img src="img/vehicleimages/<?php echo htmlentities($result['image3']);?>" width="300" height="200" style="border:solid 1px #000">
												<a href="changeimage3.php?imgid=<?php echo htmlentities($result['id_barang'])?>">Ganti Gambar 3</a>
											</div>
										</div>
										...
										<!--<div class="form-group">
											<div class="col-sm-4">
												...
												<a href="changeimage4.php?imgid=<?php //echo htmlentities($result['id_barang'])?>">Ganti Gambar 4</a>
											</div>
											<div class="col-sm-4">
												Gambar 5
											<?php //if($result//['image5']=="")
												{
													...
													<a href="changeimage5.php?imgid=<?php //echo htmlentities($result['id_barang'])?>">Ganti Gambar 5</a>
												<?php } ?>
											</div>
										</div>-->
