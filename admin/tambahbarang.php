...
<head>
	...
	<title>Jogja Adventure | Admin Tambah Barang</title>
	<!-- Font awesome -->
						...
						<div class="col-md-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<form method="post" name="theform" action="tambahbarangact.php" class="form-horizontal" onsubmit="return valid(this);" enctype="multipart/form-data">
