...
$sqlsewa = "SELECT booking.*,barang.*,merek.*,users.* FROM booking,barang,merek,users WHERE booking.id_barang=barang.id_barang
			AND merek.id_merek=barang.id_merek AND users.email=booking.email AND booking.status='$stt' 
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>RRental Alat Outdoor</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center"><h2>Rental Alat Outdoor</h2></td>
					</tr>
					<tr>
