...
$vid=$_POST['vid'];
$email=$_POST['email'];
$biayadriver=(!empty($_POST['biayadriver']) ?$_POST['biayadriver']:0);
...
$tgl=date('Y-m-d');
//insert
$sql 	= "INSERT INTO booking (kode_booking,id_barang,tgl_mulai,tgl_selesai,durasi,driver,status,email,pickup,jumlah_boking,tgl_booking)
			VALUES('$kode','$vid','$fromdate','$todate','$durasi','$biayadriver','$status','$email','$pickup','$jumlah_boking','$tgl')";

$query 	= mysqli_query($koneksidb,$sql);
if($query){
	$sqlupdate="update barang set seating=seating-$jumlah_boking where id_barang='$vid'";
	...
	for($cek;$cek<$durasi;$cek++){
		...
		$sql1	="INSERT INTO cek_booking (kode_booking,id_barang,tgl_booking,status)VALUES('$kode','$vid','$tglhasil','$status')";
...
?>
	...
	<div class="user_profile_info">	
        ...
        <form method="post" name="sewa" onSubmit="return valid();"> 
           ...
           <div class="form-group">
      <label>Jumlah</label>
				<input type="text" class="form-control" name="jumlah_boking" value="<?php echo $jumlah_boking;?>"readonly>
            </div>
