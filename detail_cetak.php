...
$kode=$_GET['kode'];
$sql1 	= "SELECT booking.*,barang.*, merek.*, users.* FROM booking,barang,merek,users WHERE booking.id_barang=barang.id_barang 
			AND merek.id_merek=barang.id_merek and booking.email=users.email and booking.kode_booking='$kode'";
...
<head>
	...
	<meta name="description" content="rental barang">
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>Jogja Adventure</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center"><h2>Jogja Adventure</h2></td>
					</tr>
					<tr>
						<td class="text-center">Yogyakata</td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
			...
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						<td>Alat</td>
						<td>:</td>
						<td><?php echo $result['nama_merek'];echo  ", "; echo $result['nama_barang']; ?></td>
					</tr>
					<tr>
						<td>Harga Sewa</td>
						<td>:</td>
					...
					<tr>
						<td>Jumlah Barang</td>
						<td>:</td>
						<td><?php echo $result['jumlah_boking'];?></td>
					</tr>
					<tr>
						<td>Biaya Alat (<?php echo $result['durasi'];?>) Hari</td>
						<td>:</td>
						<td><?php echo format_rupiah($totalbarang);?></td>
					</tr>
					<!--<tr>
